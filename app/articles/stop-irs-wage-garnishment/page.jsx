...
export const metadata = { title: "Stop IRS Wage Garnishment — The Tax Attorney | Darrin T. Mish", description: "The IRS is taking your paycheck. Not some of it — most of it. They can take up to 70% of your disposable income without a court order. You're working full ", alternates: { canonical: "/articles/stop-irs-wage-garnishment" } };
  ...
  return (
    <div style={{ fontFamily: "'Georgia', serif", color: "#1a1a1a", background: "#faf9f6", minHeight: "100vh" }}>
      ...
      <article style={{ maxWidth: 720, margin: "0 auto", padding: "56px 24px" }}>
        ...
        <h1 style={{ fontSize: 32, fontWeight: 700, lineHeight: 1.3, marginBottom: 20 }}>IRS Wage Garnishment: I Get It Stopped</h1>
        <p style={{ fontSize: 16, lineHeight: 1.7, color: "#444", marginBottom: 40, fontFamily: "system-ui" }}>The IRS is taking your paycheck. Not some of it — most of it. They can take up to 70% of your disposable income without a court order. You're working full time and can barely afford groceries. This is what I fix.</p>
        <div style={{ marginBottom: 32 }}>
          <h2 style={{ fontSize: 22, fontWeight: 700, marginBottom: 12 }}>Speed Matters</h2>
          <p style={{ fontSize: 15, lineHeight: 1.7, color: "#555", fontFamily: "system-ui" }}>Every pay period the IRS takes money you can't get back. I contact the IRS the same day you hire me. In most cases, I can get the garnishment released within days by demonstrating hardship or proposing an alternative resolution.</p>
        </div>
        <div style={{ marginBottom: 32 }}>
          <h2 style={{ fontSize: 22, fontWeight: 700, marginBottom: 12 }}>Why the IRS Garnishes</h2>
          <p style={{ fontSize: 15, lineHeight: 1.7, color: "#555", fontFamily: "system-ui" }}>The IRS garnishes wages when they've sent notices and gotten no response. By the time they levy your paycheck, they've usually sent at least four notices. If you ignored those notices, the IRS concluded you weren't going to deal with this voluntarily.</p>
        </div>
        <div style={{ marginBottom: 32 }}>
          <h2 style={{ fontSize: 22, fontWeight: 700, marginBottom: 12 }}>Releasing the Levy</h2>
          <p style={{ fontSize: 15, lineHeight: 1.7, color: "#555", fontFamily: "system-ui" }}>The IRS must release a levy if it causes economic hardship, if you enter into an installment agreement, if the statutory period for collection has expired, or if release would facilitate collection. I determine which argument works best for your situation.</p>
        </div>
        <div style={{ marginBottom: 32 }}>
          <h2 style={{ fontSize: 22, fontWeight: 700, marginBottom: 12 }}>Permanent Resolution</h2>
          <p style={{ fontSize: 15, lineHeight: 1.7, color: "#555", fontFamily: "system-ui" }}>Getting the garnishment released is step one. Step two is making sure it doesn't come back. That means resolving the underlying debt through an installment agreement, OIC, CNC status, or another strategy.</p>
        </div>
      </article>
